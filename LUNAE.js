...
(function () {
  ...
  function handleNavScroll() {
    ...
    // Glass effect once the page has scrolled a bit
  ...
  servicesTabs.forEach(tab => {
    tab.addEventListener('click', () => {
      ...
      servicesPanels.forEach(panel => {
        ...
        if (show) {
          // Re-trigger reveal animation for cards in the newly shown panel
  ...
  /* ─────────────────────────────
     9c. PORTFOLIO FILTER — Все / Ногти / Волосы
  ───────────────────────────── */
